...
resource "azurerm_mssql_server" "sql" {
  ...
  # Security fixes
  minimum_tls_version           = var.min_tls_version #CKV_AZURE_52
...
resource "azurerm_storage_account" "storage" {
  ...
  # CKV2_AZURE_41. This characteristic is enabled by default and should be configured like this or disabled
